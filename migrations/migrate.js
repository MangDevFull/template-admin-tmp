...
const importCategories = JSON.parse(await readFile(new URL('./category.json', import.meta.url)));
const importTags = JSON.parse(await readFile(new URL('./tag.json', import.meta.url)));
//
      ...
      Account.create(
        {
          profile: {
            ...
            avatar: 'https://laka-storage-vn.hn.ss.bfcplatform.vn/assets/images/avatars/a1@200.png'
          },
          username: 'member',
          phone: phoneNumber,
